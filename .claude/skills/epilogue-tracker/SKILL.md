...
Epilogue Tracker (`et`) is a CLI tool for managing work using the Screenplay Pattern. It ensures every piece of work ties back to **user goals** - what real people want to achieve, not product objectives or team metrics.
