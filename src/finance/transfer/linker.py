...
- Uses existing detection heuristics from finance.transfer.matching.
...
from finance.model.ledger_io import load_ledger_csv, dump_ledger_csv
from finance.model.account import TransactionGroup

# We reuse the matching logic from the matching module (no CLI deps)
from finance.transfer.matching import compute_matches, Match
