...
All paths are resolved from a single workspace root:
  --data-dir / FINANCE_DATA env var / current working directory
"""
...
def main(
    ...
    """Finance CLI — all paths resolved from a single workspace root."""
...
def init(ctx: typer.Context):
    ...
    Examples:
      finance --data-dir ~/finances init
      finance init
    """
    from finance.cli.command import init as cmd_init
...
def ytd(
    ...
    Examples:
      ...
      finance ytd -a MYBANK_CC --year 2024 --limit 50
      finance ytd -a BANK2_LOC --include-duplicates
    """
...
def recategorize(
    ...
    Examples:
      ...
      finance recategorize --from "Business:Meals" --to "Work:Meals" --write
...
def auto_categorize(
    ...
    Examples:
      ...
      finance auto-categorize --account MYBANK_CHQ --confidence 0.6 --write

    Safety: dry-run by default. Use --write to persist changes.
    """
    from finance.cli.command import auto_categorize as cmd_auto_categorize
...
def uncategorized(
    ...
    Examples:
      ...
      finance uncategorized --account MYBANK_CHQ --year 2025
...
def budget(
    ...
    Examples:
      ...
      finance budget --category "Dining Out"
    """
...
def report(
    ...
    Examples:
      finance report
      finance report --year 2025 --write
      finance report --year 2025 --month 10 --write
      finance report --output custom/report --write
...
def mark_duplicate(
    ...
    Transaction IDs:
      ...
      View transaction IDs with: finance ytd --account <ACCOUNT_ID>

    Note: Changes are recorded as events and projections are automatically rebuilt.
    """
    from finance.cli.command import mark_duplicate as cmd_mark_duplicate
...
def duplicates(
    ...
    Examples:
      finance duplicates
      finance duplicates --llm
      finance duplicates --interactive
      finance duplicates -i --min-confidence 0.7
      finance duplicates --llm --model qwen3:30b
...
def audit_ml(
    ...
    Examples:
      finance audit-ml
      finance audit-ml --mode training
      finance audit-ml --mode training --filter "PRESTO"
      finance audit-ml --mode predictions --limit 10
      finance audit-ml --mode features
    """
    from finance.cli.command import audit_ml as cmd_audit_ml
...
def prompt_stats(
    ...
    Examples:
      ...
      finance prompt-stats --generate-update

    Note: Requires interactive duplicate detection feedback (finance duplicates --interactive).
    """
    from finance.cli.command import prompt_stats as cmd_prompt_stats
...
def rebuild_projections(
    ...
    Examples:
      ...
      finance rebuild-projections --events-db custom/events.db
    """
    from finance.cli.command import rebuild_projections as cmd_rebuild_projections
...
def backfill_events(
    ...
    Most users should use 'finance migrate-to-events --write' instead.
    ...
    """
    from finance.cli.command import backfill_events as cmd_backfill_events
...
def migrate_to_events(
    ...
    """
    from finance.cli.command import migrate_to_events as cmd_migrate_to_events
