...
from finance.cli.command.budget import run
...
class DescribeBudgetCommand:
    ...
    def it_should_display_message_when_no_categories_defined(self):
        with TemporaryDirectory() as tmpdir:
            ...
            rc = run(config=config_path, data_dir=data_dir)
            assert rc == 0
    ...
    def it_should_show_budget_with_spending(self):
        with TemporaryDirectory() as tmpdir:
            ...
            rc = run(year=2025, config=config_path, data_dir=data_dir)
            assert rc == 0
    ...
    def it_should_filter_by_month(self):
        with TemporaryDirectory() as tmpdir:
            ...
            rc = run(year=2025, month=1, config=config_path, data_dir=data_dir)
            assert rc == 0
    ...
    def it_should_filter_by_category(self):
        with TemporaryDirectory() as tmpdir:
            ...
            rc = run(year=2025, category="Housing", config=config_path, data_dir=data_dir)
            assert rc == 0
    ...
    def it_should_error_when_month_without_year(self):
        with TemporaryDirectory() as tmpdir:
            ...
            rc = run(month=1, config=config_path, data_dir=data_dir)
            assert rc == 1
    ...
    def it_should_error_on_invalid_month(self):
        with TemporaryDirectory() as tmpdir:
            ...
            rc = run(year=2025, month=13, config=config_path, data_dir=data_dir)
            assert rc == 1
