...
from finance.cli.command import mark_duplicate
...
class DescribeMarkDuplicate:
    ...
    def mock_projections(self, tmp_path):
        ...
        from finance.model.events import TransactionImported
    ...
    def it_should_mark_duplicate_in_dry_run_mode(self, mock_projections, tmp_path, capsys):
        ...
        with patch("finance.cli.command.mark_duplicate.Prompt.ask", return_value="1"):
    ...
    def it_should_emit_duplicate_confirmed_event_with_write(
        ...
        with patch("finance.cli.command.mark_duplicate.Prompt.ask", return_value="1"):
            with patch("finance.cli.command.mark_duplicate.EventSourcingService") as mock_es:
    ...
    def it_should_use_description_from_choice(self, mock_projections, tmp_path):
        ...
        with patch("finance.cli.command.mark_duplicate.Prompt.ask", return_value="2"):
            with patch("finance.cli.command.mark_duplicate.EventSourcingService") as mock_es:
                mock_es.return_value.event_store = event_store
