"""Initialize a new finance workspace directory."""
...
# Define your spending categories here. Use 'finance category --add' to manage them,
...
def run(*, workspace: Workspace) -> int:
    """Initialize a new finance workspace with required directories and starter config.
    ...
    if not created_dirs and not created_files:
        ...
        console.print("  4. Run: finance migrate-to-events --write")
