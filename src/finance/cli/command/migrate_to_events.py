...
from finance.services.event_migration_service import EventMigrationService
from finance.services.event_sourcing_service import EventSourcingService
from finance.storage.budget_projection import BudgetProjectionBuilder
    ...
    *,
    ...
    if event_store_status.exists:
        ...
        if event_count > 0 and not force:
            ...
            console.print("  3. Use 'finance rebuild-projections' to rebuild from existing events")
            return 1
    ...
    try:
        ...
        if has_categories:
            ...
            from finance.services.event_migration_service import ValidationResult
    ...
    console.print("  • finance duplicates - Detect duplicate transactions")
    console.print("  • finance ingest - Import new data (maintains events)")
    console.print("  • finance rebuild-projections - Rebuild from events")
