...
from finance.model.account import TransactionGroup, Transaction
from finance.services.transaction_operations_service import (
    TransactionOperationsService,
    SearchCriteria,
)
from finance.services.categorization_service import CategorizationService
...
from finance.model.events import TransactionCategorized
    ...
    *,
    ...
    if not workspace.projections_path.exists():
        console.print(
            ...
            "[dim]Run 'finance rebuild-projections' first[/dim]"
        )
        return 1
