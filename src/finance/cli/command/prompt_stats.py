...
from finance.transfer.prompt_learning import PromptLearningService
from finance.model.events import PromptUpdated
...
def run(
    ...
    if not event_store_status.exists:
        ...
        console.print(
            "[yellow]Hint:[/yellow] Run 'finance ingest --write' "
    ...
    if metrics.total_feedback == 0:
        ...
        console.print("[dim]Run 'finance duplicates --interactive' to provide feedback.[/dim]")
        return 0
