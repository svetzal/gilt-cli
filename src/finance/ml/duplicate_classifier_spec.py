...
class DescribeDuplicateClassifier:
    ...
    def it_should_require_sufficient_training_data(self):
        ...
        pairs = [
            TransactionPair(
                txn1_id=f"a{i}", txn1_date=date(2025, 1, 1),
                txn1_description="TEST", txn1_amount=-10.0, txn1_account="ACC",
                txn2_id=f"b{i}", txn2_date=date(2025, 1, 1),
                txn2_description="TEST", txn2_amount=-10.0, txn2_account="ACC",
            )
            for i in range(5)
        ]
        labels = [True] * 5
    ...
    def it_should_fail_prediction_without_training(self):
        ...
        pair = TransactionPair(
            txn1_id="a", txn1_date=date(2025, 1, 1),
            txn1_description="TEST", txn1_amount=-10.0, txn1_account="ACC",
            txn2_id="b", txn2_date=date(2025, 1, 1),
            txn2_description="TEST", txn2_amount=-10.0, txn2_account="ACC",
        )
