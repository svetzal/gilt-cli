...
class Category(BaseModel):
    ...
    description: Optional[str] = Field(default=None, description="Human-readable description")
    subcategories: List[Subcategory] = Field(default_factory=list, description="Optional subcategories")
    budget: Optional[Budget] = Field(default=None, description="Optional budget allocation")
    tax_deductible: bool = Field(default=False, description="Whether expenses in this category are tax-deductible")
...
class CategoryConfig(BaseModel):
    ...
    categories: List[Category] = Field(default_factory=list, description="List of category definitions")
