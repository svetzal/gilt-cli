...
class SummaryCard(QGroupBox):
    ...
    def __init__(self, title: str, parent=None):
        ...
        self.subtitle_label.setStyleSheet(f"color: {Theme.color('text_secondary').name()};")
...
class DashboardView(QWidget):
    ...
    def _load_dashboard(self):
        ...
        if uncategorized_count > 0:
            ...
            self.uncategorized_card.set_value_color(Theme.color("warning_fg").name())
        else:
            self.uncategorized_card.set_subtitle("all categorized!")
            self.uncategorized_card.set_value_color(Theme.color("positive_fg").name())
