...
class DescribeDuplicateDetectorAdaptivePrompts:
    ...
    def it_should_load_latest_prompt_updated_event(self, tmp_path):
    ...
    def it_should_use_v1_defaults_when_no_prompt_events_exist(self, tmp_path):
    ...
    def it_should_inject_learned_patterns_into_prompt(self, tmp_path):
    ...
    def it_should_work_without_event_store_path(self):
        ...
        assert detector.prompt_version == "v1"
        assert detector.learned_patterns == []
        assert detector.model == "qwen3.6:35b-a3b-coding-nvfp4"

    def it_should_handle_multiple_prompt_versions_sequentially(self, tmp_path):
