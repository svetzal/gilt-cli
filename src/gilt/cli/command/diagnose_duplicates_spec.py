...
class DescribeDiagnose_DuplicatesCommand:
    def it_should_return_zero_when_no_issues_found(self, tmp_path):
    ...
    def it_should_return_one_when_orphan_group_present(self, tmp_path):
        workspace, projection_builder, event_store = _build_minimal_workspace(tmp_path)
    ...
    def it_should_return_one_when_stale_primary_present(self, tmp_path):
        workspace, projection_builder, event_store = _build_minimal_workspace(tmp_path)
    ...
    def it_should_return_one_when_self_referential_primary_present(self, tmp_path):
        workspace, projection_builder, event_store = _build_minimal_workspace(tmp_path)
    ...
    def it_should_return_one_when_projections_db_is_missing(self, tmp_path):
        workspace = Workspace(root=tmp_path)
