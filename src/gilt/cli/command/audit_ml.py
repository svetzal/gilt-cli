...
def show_summary(console: Console, builder: TrainingDataBuilder) -> int:
    ...
    if stats['total_examples'] > 0:
        ...
        console.print(f"[dim]Use 'gilt audit-ml --mode features' to see feature importance[/dim]")
        console.print(f"[dim]Use 'gilt audit-ml --mode predictions' to test on current data[/dim]")
