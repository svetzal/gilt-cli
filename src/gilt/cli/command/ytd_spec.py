...
from gilt.testing import make_group, make_workspace
...
class DescribeYtdCompareFlag:
    ...
    def it_should_show_only_enriched_transactions(self, tmp_path):
    ...
    def it_should_return_zero_when_no_enriched_transactions(self, tmp_path):
        workspace = make_workspace(tmp_path, init_dirs=["ledger_data_dir"])
    ...
    def it_should_not_filter_transactions_without_compare_flag(self, tmp_path):
        workspace = make_workspace(tmp_path, init_dirs=["ledger_data_dir"])
...
class DescribeYtdServiceDisplay:
    ...
    def it_should_show_vendor_dash_service_when_service_present(self, tmp_path):
        workspace = make_workspace(tmp_path, init_dirs=["ledger_data_dir"])
    ...
    def it_should_show_only_vendor_when_service_is_null(self, tmp_path):
        workspace = make_workspace(tmp_path, init_dirs=["ledger_data_dir"])
    ...
    def it_should_show_service_column_in_compare_mode(self, tmp_path):
        workspace = make_workspace(tmp_path, init_dirs=["ledger_data_dir"])
    ...
    def it_should_show_raw_description_in_raw_mode_even_with_service(self, tmp_path):
        workspace = make_workspace(tmp_path, init_dirs=["ledger_data_dir"])
